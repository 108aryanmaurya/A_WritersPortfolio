...
const ArticleBody = ({ articledata }) => {
  ...
  return (
    <div className="relative max-md:w-full w-[90%] mx-auto p-16 max-sm:p-0 max-md:mt-8   justify-center items-center">
      <div
        className="
font-Gamiliademo  w-[90%] max-md:w-[90%] mx-auto  text-[45px] max-md:text-[30px] max-md:leading-9 "
      >
        {articledata?.title}
      </div>
      ...
      <div className="mt-10 max-md:mt-6   max-md:p-4  p-10  bg-white ">
        ...
        <div
          className="text-[18px] tracking-wide     text-justify max-lg:w-[100%] max-md:w-[100%]  max-md:leading-[18px] max-md:text-[13px]  font-TimesNewRoman        "
