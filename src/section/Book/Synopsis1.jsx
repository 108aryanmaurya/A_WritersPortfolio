  ...
  return (
    <section className="relative max-md:mt-14 flex mt-14">
      <div className="flex justify-between max-md:justify-center  max-md:flex-col  items-center">
        ...
        <div className="z-20 mr-72 text-black  max-md:top-[84px] max-md:bg-white max-md:mr-0 bg-white text-[18px]   w-[40%]   max-md:text-[17px] max-md:leading-[21px] font-Slab max-md:py-6       max-md:ml-0  max-sm:mt-0  max-md:my-0  my-20 max-md:w-full max-md:p-4  p-10  text-justify  ">
