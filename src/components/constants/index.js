...
export const articles = [
  {
    title:
      "A assumenda excepturi ut quia expedita, cum odio nemo vitae Possimus ea veniam ",
    description:
      "Voluptates, vero consequatur exercitationem tempora recusandae doloqui? Quaerat commodi quae beatae sequi rem minus, recusandae maxime?",
  },
  {
    title: "Impedit accusantium voluptates corporis itaque beatae, ",
    description:
      "xercitationem perspiciatis voluptatem iste harum quis, doloribus repellendus! Similique dicta temporibus trum! Laborum aperiam quas praesentium quo consequuntu",
  },
  {
...
export const ReaderReview = [
  { review: "tempora recusandae dolore sapiente dicta dignissimos alias corrupti placeat optio, quisquam pariatur!Nuam alias molestias voluptatibus, quod cumque officiis rerum " },
  { review: "eligendi aliquam alias molestias voluptatibus, quod cumque officiis rerum Impedit accusantium voluptates corporis itaque beatae, repellendus enim harum laboriosam" },
  { review: "animi explicabo quam recusandae assumenda, sed nostrum, officiis delectus, error itaque possimus. Beatae sequi ipsam quibusdam, quo aliquam dolorem illo sint suscipit, rem" },
  { review: " provident maxime necessitatibus perferendis dicta neque asperiores cum sit fuga omnis eos architecto rem similique possimus qui? Quaerat commodi quae beatae" },
  { review: "Quia cum culpa rem doloremque sed officiis laborum omnis, sapiente ratione iste voluptatum laboriosam est, at dolor accusamus eaque corrupti ducimus!" },
]
