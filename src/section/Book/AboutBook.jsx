...
const AboutBook = () => {
  return (
    ...
    >
      <div className="  absolute p-12 ml-20 max-md:ml-0 bg-slate-200 max-md:pr-20 max-md:p-3  pr-64 ">
        <img
          src={cover1}
          alt="person"
      ...
      <div
        className="text-[18px] z-30  ml-[696px] 
       max-md:right-3 max-md:top-32   top-10 right-10 text-justify bg-white w-[40%] max-md:w-[75%] max-sm:p-3 max-md:text-[12px] max-sm:leading-[17px] font-montserrat   max-sm:ml-8 max-sm:mt-14   mt-24 h-full p-14 max-  "
      >
