...
const Article = () => {
  ...
  return (
    <section className="max-md:my-10 my-20  ">
      <div className=" text-center text-[29px] my-12 max-md:my-2 font-[100] font-CooperHevitt">
        ARTICLE
      </div>
      <div className="px-40  flex flex-col items-center justify-center mt-7 max-md:mt-6 max-md:ml-0 max-md:px-3   max-md:mx-4 max-md:gap-9 gap-14">
        {articles.map((art) => (
          <div
            key={2}
          ...
          >
            <div className="flex ">
              <span className="text-[30px] w-[75%] max-md:w-[90%]     max-md:text-[20px]  uppercase text-gray-800 font-Oswald max-md:leading-7 max-md:mb-2">
                {art.title}
              </span>{" "}
