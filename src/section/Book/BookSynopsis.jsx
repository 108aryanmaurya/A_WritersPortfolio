...
const BookSynopsis = () => {
  return (
    <section className="relative max-md:mt-6 flex mt-36">
      <div className="flex justify-between  max-md:flex-col  items-center">
        ...
        <div className=" z-30  text-[35px]  font-bold  max-md:text-[23px] absolute  left-40 max-md:top-14  font-[100] font-CooperHevitt     border-b-[3px] tracking-widest    text-white border-white ">
          SYNOPSIS
        </div>
        <div className="z-20 mr-72 max-md:absolute max-md:top-40 max-md:bg-opacity-[0.1]  max-md:text-white   max-md:mr-0 bg-white text-[18px]   w-[40%] max-md:w-[90%]  max-md:text-[14px] max-md:leading-[19px] font-montserrat    max-md:ml-0  max-sm:mt-0  max-md:my-0  my-20   p-10 max-md:p-3 text-justify  ">
