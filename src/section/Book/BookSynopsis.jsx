  ...
  return (
    <section className="relative max-md:mt-14 flex mt-14">
      <div className="flex justify-between max-md:justify-center  max-md:flex-col  items-center">
        ...
        <div className="z-20 mr-72 max-md:absolute max-md:top-[84px] max-md:bg-opacity-[0.1]  max-md:text-white   max-md:mr-0 bg-white text-[18px]   w-[40%] max-md:w-[90%]  max-md:text-[15px] max-md:leading-[19px] font-montserrat    max-md:ml-0  max-sm:mt-0  max-md:my-0  my-20   p-10 max-md:p-3 text-justify  ">
