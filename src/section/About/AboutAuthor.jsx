  ...
  return (
    <>
      <div className="relative  p-16 max-sm:p-0 max-sm:mt-4  max-sm:ml-4  justify-center items-center">
        ...
        <div className="text-[18px]  text-justify bg-white w-[60%] max-sm:w-[85%] max-sm:p-3 max-md:text-[12px] max-sm:leading-[17px] font-montserrat   max-sm:ml-8 max-sm:mt-14  ml-24 mt-24  p-14 max-  ">
